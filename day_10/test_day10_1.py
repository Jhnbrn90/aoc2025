...
@pytest.mark.parametrize('input_str,machine,buttons', [
    ...
    ('[#.#......] (2,3,4,5,6,7,8) (0,1,2,3,7) (1,2,3,4,8) (1,2,3,4,5,6,8) (0,4,6,7,8) (4,6,7) (5) (0,1,3,7,8) {13,30,32,41,36,25,29,24,45}', '[#.#......]', ['(2,3,4,5,6,7,8)', '(0,1,2,3,7)', '(1,2,3,4,8)', '(1,2,3,4,5,6,8)', '(0,4,6,7,8)', '(4,6,7)', '(5)', '(0,1,3,7,8)']),
])
